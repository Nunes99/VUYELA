...
This repository has completed **FASE 06 — Loyalty engine**.
...
Product features such as production POS flows, dashboards with real data, marketplace data, and digital cards are intentionally not implemented yet.
